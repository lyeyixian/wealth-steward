...
├── CONTEXT.md
├── docs/adr/
│   ├── 0001-ai-agent-is-the-product.md
│   ├── 0002-actual-budget-as-headless-ledger.md
│   └── ...
└── src/
```
...
> _Contradicts ADR-0001 (the AI agent is the product) — but worth reopening because…_
